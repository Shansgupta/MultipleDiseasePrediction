...
if selected == "Diabetes Prediction":
    ...
    if heart_preprocessor and diabetes_model:
        ...
        with col2:
            smoking_history = st.selectbox('Smoking History', ['never', 'No Info', 'current', 'former', 'ever', 'not current'], key='d_smoke')
        ...
        if st.button('**Predict Diabetes**', type="primary"):
            ...
            transformed_data =  heart_preprocessor.transform(input_data)
